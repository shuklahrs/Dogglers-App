...
class DogCardAdapter(
    ...
    class DogCardViewHolder(view: View?): RecyclerView.ViewHolder(view!!) {
        ...
        val nameView = view?.findViewById<TextView>(R.id.name_item)
        val ageView = view?.findViewById<TextView>(R.id.age_item)
        val hobbiView = view?.findViewById<TextView>(R.id.hobbies_item)
    }
    ...
    override fun onBindViewHolder(holder: DogCardViewHolder, position: Int) {
        ...
        holder.hobbiView?.text = resources?.getString(R.string.dog_hobbies, dog.hobbies)
